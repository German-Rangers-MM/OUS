class IGC_CF_dialog {
    ...
    class controls {
        ...
        class IGC_ButtonMiclic: IGC_ButtonEmptyBox {
            text = "a3\ui_f\data\igui\cfg\actions\loadvehicle_ca.paa";
            x = IGC_GETCX(IGC_X_VAL,IGC_WIDTH_VAL,4.5,16);
            tooltip = "MICLIC anfordern";
            action = "[""miclic""]call IGC_CF_fnc_spawnExtraGear;";
        };
