...
intro 				= "Vanilla";		// Choose the Intro Music that is played (please delete mmc_sequence_xxx.sqf files that you don't need and the corresponding intro soundfiles under sounds/)
...
einleitung 			= "Fliegende Herzen ist ein Film von Dominique Deruddere. Er hat nichts mit der Mission zu tun.";	// Hier kannst du den Einleitungstext anpassen, der im Intro angezeigt wird. HTML-Tags funktionieren hier auch, z.B. <br/> für Zeilenumbruch
auftrag 			= "Auftrag: <br/>1. Hilfsgüter ausliefern<br/>2. Bevölkerung helfen";
titleOrtEinheit		= "T A K I S T A N - 16.02.2026 - German Rangers";
titleMissionsname 	= "OP Flying Hearts";

tickerCountry 		= "Takistan, Nord Region";	// Hier kannst du den Ort anpassen, der im Ticker angezeigt wird
tickerLocation 		= "Sarcasma Distrikt";	// Hier kannst du die genaue Location anpassen, die im Ticker angezeigt wird

outro 				= "Vanilla";		// Hier kannst du die Musik wählen, die bei einem Erfolgreichen Missionsende gespielt wird Rock
									...
									// "Video" Musik wird im Intro-File festgelegt
outroContinue		= "Vanilla";	// Hier kannst du die Musik wählen, die bei einem Fortgesetzten Missionsende gespielt wird Rock
                                    // "Default" Huntsman
                                    // "Vanilla"
outroFailed			= "Vanilla";	// Hier kannst du die Musik wählen, die bei einem Fehlgeschlagenen Missionsende gespielt wird Rock
                                    // "Default" Huntsman
                                    // "Vanilla"