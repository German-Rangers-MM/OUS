...
titleText ["<img image='images\GermanRangersLogo.paa' shadow='0' size='8'/><img image='images\JTF-OUS_Insignia_512px.paa' shadow='0' size='8'/> <br/>
			<t color='#ffffff' size='5' font='RobotoCondensed' shadow = '2' >M I S S I O N  F A I L E D</t>
			<br/>
			<br/>
			<t color='#ffffff' size='1.5' font='RobotoCondensed' shadow = '2' >Auftrag beendet.</t>", 
			"PLAIN", 2, true, true
		];
...
_personalText =  format ["<br/><br/><br/><br/><img image='images\GermanRangersLogo.paa' shadow='0' size='8'/><img image='images\JTF-OUS_Insignia_512px.paa' shadow='0' size='8'/><br/><br/><t color='#ffffff' size='2.5' font='RobotoCondensed' shadow = '2' >B I S  N A E C H S T E  W O C H E ,<br/><br/>   %1</t><br/><br/><t color='#ffffff' size='1.5' font='RobotoCondensed' shadow = '2' >Danke für deinen Einsatz bei den German Rangers!</t>", _playerName];
