...
einleitung 			= "Vento portatus - Vom Winde getragen";	// Hier kannst du den Einleitungstext anpassen, der im Intro angezeigt wird. HTML-Tags funktionieren hier auch, z.B. <br/> für Zeilenumbruch
auftrag 			= "Auftrag: <br/>1. Nach Sarcasma verlegen<br/>2. Kontakt mit lokalen Oberhaupt aufnehmen";
titleOrtEinheit		= "T A K I S T A N - 16.02.2026 - German Rangers";
titleMissionsname 	= "OP MISTRAL NOMAD";

tickerCountry 		= "Takistan, Nord Region";	// Hier kannst du den Ort anpassen, der im Ticker angezeigt wird
tickerLocation 		= "Talstrasse bei Sarcasma";	// Hier kannst du die genaue Location anpassen, die im Ticker angezeigt wird
