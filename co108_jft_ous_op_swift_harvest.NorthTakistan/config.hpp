...
einleitung 			= "Frigus est spiritus - Kalt ist der Atem";	// Hier kannst du den Einleitungstext anpassen, der im Intro angezeigt wird. HTML-Tags funktionieren hier auch, z.B. <br/> für Zeilenumbruch
...
titleMissionsname 	= "OP SWIFT HARVEST";
