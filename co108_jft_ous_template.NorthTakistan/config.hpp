...
einleitung 			= "Die Ranger geben sich Mühe die Hearts and Minds der Bevölkerung an Wänden und Decken zu verteilen.";	// Hier kannst du den Einleitungstext anpassen, der im Intro angezeigt wird. HTML-Tags funktionieren hier auch, z.B. <br/> für Zeilenumbruch
auftrag 			= "Auftrag: <br/>1. <br/>2. <br/>3.";
titleOrtEinheit		= "T A K I S T A N - DD.MM.YYYY - German Rangers";
titleMissionsname 	= "Template";

tickerCountry 		= "Takistan, Nord Region";	// Hier kannst du den Ort anpassen, der im Ticker angezeigt wird
tickerLocation 		= "Region";	// Hier kannst du die genaue Location anpassen, die im Ticker angezeigt wird
